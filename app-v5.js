(() => {
  ...
  const copy = {
    es: {
      meta: { title: "Prompts para Suno de country, metal, trap y hip-hop | SUBSUELO FS", description: "Ocho packs de prompts probados en Suno: country, metal sinfónico, trap, UK garage, jungle, hip-hop, dub y noir. Cada pack cuesta 9 €." },
    ...
    product: { edition: "CARPETA DE PROMPTS", compatibility: "Compatible con Suno · referencia generada y comprobada", demoFolderName: "AUDIO_EXAMPLES", add: "Añadir al carrito", buy: "Comprar ahora", play: "Escuchar 30 s", sampler: "Probar muestra gratis · 0 €", contents: "Contenido de la descarga", name: "Nombre", type: "Tipo", folder: "Carpeta", description: "Qué contiene", availability: "Acceso", purchase: "Descarga disponible después del pago", files: "{count} elementos", included: "Incluido en la descarga", available: "Disponible después de la compra", public: "Información pública", details: "Ver información", open: "Abrir", listen: "Escuchar", readme: "Resumen de la descarga, organización de los archivos y primeros pasos.", promptsFolder: "PDF con todos los prompts en inglés, numerados y listos para copiar.", negativesFolder: "PDF separado con todos los negative prompts en inglés, numerados y listos para copiar.", guideFile: "Explica dónde pegar cada texto, cómo crear con o sin voz y qué cambia al mover los controles.", demosFolder: "Carpeta con 4 MP3 incluidos para escucha y referencia. El reproductor público ofrece una muestra.", audioIncluded: "MP3 completo incluido para escucha y referencia después del pago.", previewDescription: "Extracto público de 30 segundos de uno de los audios incluidos.", demosIncluded: "4 MP3 incluidos + muestra pública", licenseFile: "Condiciones de uso de los prompts, negative prompts y audios de ejemplo.", esFolder: "Documentos en español; los textos que se copian permanecen en inglés.", enFolder: "Documentos en inglés; los prompts preparados para copiar también están en inglés.", format: "Formato", language: "Idioma", content: "Contenido", english: "Inglés", spanishDocs: "Español · prompts en inglés", englishDocs: "Inglés · prompts en inglés", afterPurchase: "Se entrega dentro de la descarga después del pago.", review: "Puedes comprobar qué contiene y en qué idioma está antes de comprar.", mainPrompt: "Prompt completo en inglés, listo para copiar.", negativePrompt: "Lista en inglés para pegar en Exclude.", audioPreview: "Muestra pública", previewOnly: "Solo escucha", notInZip: "La escucha pública es una muestra; la compra incluye 4 MP3 para referencia.", perPrompt: "0,30 € por prompt", upsellTitle: "¿Te interesan varios géneros?", upsellText: "Pack completo: las 6 carpetas por 49 € · ahorras 5 €", upsellAction: "Ver pack completo · 49 €" },
      ...
      help: { kicker: "AYUDA / EMPIEZA_AQUI.txt", title: "Qué incluye cada carpeta", lead: "Cada compra incluye una carpeta ES, otra EN y AUDIO_EXAMPLES. Los prompts probados en Suno están en inglés en las dos versiones; las explicaciones cambian de idioma.", prompt: "PROMPTS", promptText: "El PDF PROMPTS reúne todos los prompts de la carpeta. Elige uno y pégalo completo en el campo Styles de Suno.", negative: "NEGATIVE PROMPTS", negativeText: "El PDF NEGATIVE PROMPTS reúne listas para el campo Exclude de Suno. Usa una cuando quieras evitar voces u otro elemento concreto indicado en la lista.", guide: "GUÍA", guideText: "Hay una guía en español y la misma guía en inglés. Explica dónde pegar cada bloque, cómo trabajar con o sin voz y qué hace cada control.", demos: "EJEMPLOS DE AUDIO", demosText: "La descarga incluye 4 MP3 para escuchar como referencia del sonido probado. No tienen licencia de sampleo, publicación o reutilización.", direction: "Elige un prompt y pégalo en Styles", outside: "Usa Exclude solo si quieres quitar algo", together: "Para empezar solo necesitas un prompt. El negative prompt es opcional y sirve para excluir algo concreto.", delivery: "Después del pago recibes las carpetas ES, EN y AUDIO_EXAMPLES." },
      demos: { kicker: "AUDIO / MUESTRAS", title: "Escucha ocho resultados de prompts para Suno.", lead: "Cada muestra se generó con un prompt de su carpeta correspondiente. Cada pack incluye además 4 MP3 completos que muestran el sonido probado.", track: "Pista", edition: "Carpeta", length: "Duración", action: "Acción", open: "Abrir carpeta", samplerTitle: "¿Te gusta lo que oyes?", samplerText: "La muestra gratuita incluye 6 prompts, 7 negative prompts y seis de estas ocho demos.", samplerAction: "Probar muestra gratis · 0 €" },
      bundle: { kicker: "PACK COMPLETO", title: "Todas las carpetas", lead: "Las seis colecciones probadas en Suno: 180 prompts, 60 negative prompts, guías ES/EN y 24 referencias MP3 en un ZIP. Las publicaciones futuras se venden por separado.", members: "Carpetas incluidas", add: "Añadir pack completo", item: "Incluida en el pack", folderCount: "{count} carpetas", saving: "Precio actual de los seis por separado: {separate} · Ahorras {saving} · 0,27 € por prompt" },
      ...
      demoOffer: { titlebar: "HAS ESCUCHADO LA MUESTRA", kicker: "30 SEGUNDOS / DECISIÓN RÁPIDA", title: "Si este sonido te encaja, aquí está el pack.", includes: "30 prompts + 10 negative prompts + guías ES/EN + 4 MP3", buy: "COMPRAR AHORA", open: "Ver la ficha completa", sampler: "Prefiero probar la muestra gratis", close: "Cerrar esta oferta" },
    ...
    en: {
      meta: { title: "Suno prompts for country, metal, trap and hip-hop | SUBSUELO FS", description: "Eight tested Suno prompt packs: country, symphonic metal, trap, UK garage, jungle, hip-hop, dub and noir. €9 per pack." },
      ...
      help: { kicker: "HELP / START_HERE.txt", title: "What each folder includes", lead: "Every purchase contains an ES folder, an EN folder and AUDIO_EXAMPLES. The Suno-tested prompts are ready to copy in English; the guides explain where each block goes.", prompt: "PROMPTS", promptText: "The PROMPTS PDF contains every prompt in the folder. Choose one and paste it in full into Suno's Styles field.", negative: "NEGATIVE PROMPTS", negativeText: "The NEGATIVE PROMPTS PDF contains lists for Suno's Exclude field. Use one when you want to avoid vocals or another specific element named by the list.", guide: "GUIDE", guideText: "There is one Spanish guide and the same guide in English. It shows where each block goes, how to work with or without vocals, and what each control changes.", demos: "AUDIO EXAMPLES", demosText: "The download includes 4 MP3 files as tested sound references. They are not licensed for sampling, release or reuse.", direction: "Choose one prompt and paste it into Styles", outside: "Use Exclude only when you want to remove something", together: "You only need one prompt to begin. A negative prompt is optional and is used to exclude something specific.", delivery: "After payment, you receive the ES, EN and AUDIO_EXAMPLES folders." },
      demos: { kicker: "AUDIO / PREVIEWS", title: "Hear eight Suno prompt results before you choose.", lead: "Each preview was generated from a prompt in its corresponding folder. Every pack also includes four full MP3 references that show the tested sound.", track: "Track", edition: "Folder", length: "Length", action: "Action", open: "Open folder", samplerTitle: "Like what you hear?", samplerText: "The free sampler includes 6 prompts, 7 negative prompts and six of these eight demos.", samplerAction: "Try free sampler · €0" },
      bundle: { kicker: "COMPLETE PACK", title: "All six folders. One download.", lead: "Six Suno-tested collections: 180 prompts, 60 negative prompts, ES/EN guides and 24 MP3 references in one ZIP. Future releases are separate.", members: "Included folders", add: "Add complete pack", item: "Included in the pack", folderCount: "{count} folders", saving: "Current price of all six separately: {separate} · Save {saving} · €0.27 per prompt" },
      ...
      demoOffer: { titlebar: "YOU HEARD THE PREVIEW", kicker: "30 SECONDS / QUICK DECISION", title: "If this sound fits, here is the pack.", includes: "30 prompts + 10 negative prompts + ES/EN guides + 4 MP3s", buy: "BUY NOW", open: "View the complete product", sampler: "I prefer to try the free sampler", close: "Close this offer" },
  ...
  const catalog = [
    ...
    { id: "dust", sku: "DUST-COUNTRY", name: "Dust Country", price: 9, tone: "#8B4E2D", tags: ["country"], category: { es: "Country moderno y outlaw", en: "Modern and outlaw country" }, counts: { prompts: 30, negatives: 10, demos: 4 }, description: { es: "30 direcciones de country moderno, outlaw country, americana oscura y country rock con instrumentación concreta, arreglos controlados y espacio real para voz.", en: "30 focused routes into modern country, outlaw country, dark Americana and country rock, with specific instrumentation, controlled arrangements and real vocal space." }, demo: { title: "Night Mileage", src: "./audio/dust-country-night-mileage-preview.mp3", durationLabel: "00:30", files: ["001_NIGHT_MILEAGE_A.mp3", "001_NIGHT_MILEAGE_B.mp3", "016_LAST_PAYPHONE_A.mp3", "016_LAST_PAYPHONE_B.mp3"] } },
    { id: "iron", sku: "IRON-CHOIR", name: "Iron Choir", price: 9, tone: "#4D5668", tags: ["metal"], category: { es: "Metal sinfónico, doom y gótico", en: "Symphonic, doom and gothic metal" }, counts: { prompts: 30, negatives: 10, demos: 4 }, description: { es: "30 direcciones de metal sinfónico oscuro, doom y metal gótico que mantienen guitarras, batería y orquesta separadas, pesadas y reconocibles.", en: "30 focused routes into dark symphonic metal, symphonic doom and gothic metal, keeping guitars, drums and orchestra separate, heavy and recognisable." }, demo: { title: "Ashen Procession", src: "./audio/iron-choir-ashen-procession-preview.mp3", durationLabel: "00:30", files: ["001_ASHEN_PROCESSION_A.mp3", "001_ASHEN_PROCESSION_B.mp3", "030_IRON_CHOIR_A.mp3", "030_IRON_CHOIR_B.mp3"] } }
  ];

  // Public prompt 001 selections. The first six also appear in the free sampler.
  const samplerProofs = Object.freeze({
    ...
    dust: Object.freeze({
      title: "NIGHT MILEAGE",
      prompt: "Modern country song, 92 BPM; a steady road-worn 4/4 pocket and a calm forward pull. Drums: a compact kick, dry cross-stick snare, brushed hat eighth notes and a restrained tambourine lift only in the chorus. Bass: a warm electric bass hold simple root-and-fifth movement, slightly behind the kick. Core: a close-miked steel-string acoustic guitar carry a two-chord verse figure, answered by short clean electric-guitar bends and a low pedal-steel shadow. Arrangement: the verse stays sparse, the pre-chorus adds bass movement and the chorus widens through doubled guitars without adding glossy pop layers. Mix: dry, warm and human, with audible pick texture, controlled low mids and a vocal-sized opening in the centre. Keep one groove and tonal identity; vary performance, dynamics and layers. Avoid trap drums, arena-rock guitars, synthetic claps, oversized cinematic swells and polished pop-country sheen."
    }),
    iron: Object.freeze({
      title: "ASHEN PROCESSION",
      prompt: "Dark symphonic metal, 132 BPM; a weighty 4/4 march with controlled double-kick support rather than constant speed. Drums: tight kick pairs beneath selected riff accents, a deep snare, closed hats in verses and broad crashes only on chorus downbeats. Bass: a distorted bass guitar double the root movement while remaining clearly separated from the kick. Core: low cellos and violas reinforce a descending guitar riff, while restrained brass colour and a mixed choir sustain harmony rather than melody. Arrangement: the verse stays riff-led, the chorus opens through strings and choir, and the bridge returns to the main motif in half density instead of becoming a trailer cue. Mix: massive but disciplined, with articulate guitars, real drum transients and orchestral layers placed behind the band. Keep one groove and tonal identity; vary performance, dynamics and layers. Avoid heroic brass fanfares, cinematic booms, spoken narration, constant blast beats, power-metal speed and pop production."
    })
  });
  ...
  const productEditorial = Object.freeze({
    ...
    dust: {
      core: { es: "Country moderno nocturno y seco con acústicas cercanas, batería humana, bajo eléctrico y detalles de pedal steel o Telecaster.", en: "Dry nocturnal modern country with close acoustic guitars, human drums, electric bass and pedal-steel or Telecaster detail." },
      changes: {
        es: ["pocket recto o arrastrado", "acústica rasgueada o fingerpicked", "bajo eléctrico o upright", "pedal steel, fiddle o barítona", "tamaño del estribillo", "habitación seca o carretera abierta"],
        en: ["straight or laid-back pocket", "strummed or fingerpicked acoustic", "electric or upright bass", "pedal steel, fiddle or baritone guitar", "chorus size", "dry room or open-road space"]
      },
      fit: { es: "Canciones country con madera, carretera y tensión contenida, desde modern country hasta outlaw y americana oscura sin brillo pop genérico.", en: "Country songs with wood, road wear and restrained tension, from modern country to outlaw and dark Americana without generic pop gloss." },
      demo: { es: "Country moderno a 92 BPM con acústica seca, cross-stick, bajo cálido y una guitarra eléctrica que responde sin llenar el centro.", en: "Modern country at 92 BPM with dry acoustic guitar, cross-stick, warm bass and electric-guitar answers that leave the centre open." },
      related: ["noir", "garage"]
    },
    iron: {
      core: { es: "Metal sinfónico oscuro con riffs legibles, batería pesada y capas orquestales colocadas detrás de la banda en vez de sustituirla.", en: "Dark symphonic metal with readable riffs, heavy drums and orchestral layers placed behind the band rather than replacing it." },
      changes: {
        es: ["marcha, medio tiempo o doble bombo", "riff grave o pedal", "cuerdas, metales o coro", "doom, gótico o sinfónico", "densidad del estribillo", "sala de banda u orquesta amplia"],
        en: ["march, half-time or double kick", "low riff or pedal note", "strings, brass or choir", "doom, gothic or symphonic balance", "chorus density", "band room or wide orchestra"]
      },
      fit: { es: "Metal oscuro donde las guitarras conservan peso y definición mientras cuerdas y coro amplían la armonía sin convertirlo en música de tráiler.", en: "Dark metal where guitars retain weight and definition while strings and choir widen the harmony without turning into trailer music." },
      demo: { es: "Marcha de metal sinfónico a 132 BPM con riff descendente, cuerdas graves y coro sostenido detrás de una batería contenida.", en: "A 132 BPM symphonic-metal march with a descending riff, low strings and sustained choir behind controlled drums." },
      related: ["trap", "dust"]
    }
  });

  const productPitches = Object.freeze({
    trap: { es: "808 dominante, batería seca y percusión ritual para trap oscuro con espacio.", en: "Dominant 808s, dry drums and ritual percussion for dark trap with space." },
    garage: { es: "2-step nocturno, swing humano y subgrave preciso sin acabado EDM genérico.", en: "Nocturnal 2-step, human swing and precise sub-bass without generic EDM polish." },
    jungle: { es: "Breaks recortados, subgrave pesado y textura de cinta para jungle degradado.", en: "Chopped breaks, heavy sub-bass and tape wear for degraded jungle." },
    low: { es: "Hip-hop abstracto con graves frontales, pocos elementos y textura áspera.", en: "Abstract hip-hop with forward low end, sparse arrangements and rough texture." },
    abyss: { es: "Batería de rap, bajos de sound-system y ecos profundos que dejan respirar el beat.", en: "Rap drums, sound-system bass and deep echoes that let the beat breathe." },
    noir: { es: "Boom bap nocturno con muestras acústicas, batería polvorienta y cinta usada.", en: "Nocturnal boom-bap with acoustic samples, dusty drums and worn tape." },
    dust: { es: "Country moderno y outlaw con acústicas cercanas, batería humana y hueco para voz.", en: "Modern and outlaw country with close acoustics, human drums and room for vocals." },
    iron: { es: "Metal sinfónico oscuro con riffs legibles, batería pesada y orquesta bien separada.", en: "Dark symphonic metal with readable riffs, heavy drums and a clearly separated orchestra." }
  });
  ...
  const familyDefinitions = Object.freeze([
    {
      id: "electronic",
      slug: "electronica",
      label: "sidebar.familyElectronic",
      ...
      meta: {
        es: { title: "Prompts para Suno de electrónica: UK garage y jungle | SUBSUELO FS", description: "Compara packs de prompts para Suno de UK garage oscuro y jungle degradado. Escucha demos, revisa el sonido y elige 30 prompts por 9 €." },
        en: { title: "Electronic Suno prompts: UK garage and jungle | SUBSUELO FS", description: "Compare dark UK garage and degraded jungle Suno prompt packs. Hear demos, review the sound and choose 30 prompts for €9." }
      },
      categories: ["garage", "jungle"],
    ...
    },
    {
      ...
      meta: {
        es: { title: "Prompts para Suno de hip-hop oscuro, trap, dub y noir | SUBSUELO FS", description: "Compara cuatro packs de prompts para Suno: trap oscuro, hip-hop abstracto, dub y noir. Demos reales, 30 prompts por pack y precio de 9 €." },
        en: { title: "Dark hip-hop Suno prompts: trap, dub and noir | SUBSUELO FS", description: "Compare four Suno prompt packs for dark trap, abstract hip-hop, dub and noir. Real demos, 30 prompts per pack and a €9 price." }
      },
      categories: ["trap", "hiphop", "dub", "noir"],
    ...
    },
    {
      ...
      meta: {
        es: { title: "Prompts para Suno de country y metal sinfónico | SUBSUELO FS", description: "Compara packs de prompts para Suno de country moderno, outlaw y metal sinfónico oscuro. Escucha demos y elige 30 prompts por 9 €." },
        en: { title: "Country and symphonic metal Suno prompts | SUBSUELO FS", description: "Compare modern country, outlaw and dark symphonic metal Suno prompt packs. Hear demos and choose 30 prompts for €9." }
      },
      categories: ["country", "metal"],
      products: ["dust", "iron"],
      guides: ["suno-country-prompts", "suno-metal-prompts"]
    }
  ]);
  const familyRouteIds = new Map(familyDefinitions.map((family) => [family.slug, family.id]));
  const familyById = Object.freeze(Object.fromEntries(familyDefinitions.map((family) => [family.id, family])));
  const guideLabels = Object.freeze({
    "make-dark-uk-garage": { es: "Cómo crear UK garage oscuro", en: "How to make dark UK garage" },
    "make-dark-jungle": { es: "Cómo crear jungle oscuro", en: "How to make dark jungle" },
    "make-dark-trap": { es: "Cómo crear trap oscuro", en: "How to make dark trap" },
    "make-abstract-hip-hop": { es: "Cómo crear hip-hop abstracto", en: "How to make abstract hip-hop" },
    "make-dub-hip-hop": { es: "Cómo crear hip-hop dub", en: "How to make dub hip-hop" },
    "make-noir-hip-hop": { es: "Cómo crear hip-hop noir", en: "How to make noir hip-hop" },
    "suno-country-prompts": { es: "Prompts de country para Suno", en: "Country prompts for Suno" },
    "suno-metal-prompts": { es: "Prompts de metal para Suno", en: "Metal prompts for Suno" }
  });

  const archiveMemberIds = Object.freeze(["trap", "garage", "jungle", "low", "abyss", "noir"]);
  const archiveProducts = archiveMemberIds.map((id) => catalog.find((product) => product.id === id));
  const catalogueTotals = archiveProducts.reduce((totals, item) => ({ prompts: totals.prompts + item.counts.prompts, negatives: totals.negatives + item.counts.negatives }), { prompts: 0, negatives: 0 });
  const archive = { id: "archive", sku: "COMPLETE-PACK", name: { es: "Pack completo", en: "Complete pack" }, price: 49, tone: "#a44730", bundle: true, members: [...archiveMemberIds], description: { es: `Las seis colecciones originales en un solo ZIP: ${catalogueTotals.prompts} prompts y ${catalogueTotals.negatives} negative prompts. Dust Country e Iron Choir se venden por separado.`, en: `The original six collections in one ZIP: ${catalogueTotals.prompts} prompts and ${catalogueTotals.negatives} negative prompts. Dust Country and Iron Choir are sold separately.` } };
  const separateCataloguePrice = archiveProducts.reduce((total, product) => total + product.price, 0);
  const archiveSaving = separateCataloguePrice - archive.price;
  const payhipProductKeys = Object.freeze({ trap: "0GiEq", garage: "HunFY", jungle: "LmWUN", low: "LrzFf", abyss: "TxsAr", noir: "8sFfE", dust: "35inF", iron: "lpLuv", archive: "SPXoI" });
  ...
  const productSeo = Object.freeze({
    trap: {
      es: { title: "Trap Ritual: prompts de trap oscuro para Suno | SUBSUELO FS", description: "30 prompts de trap oscuro para Suno, probados con referencias reales. Incluye 10 negative prompts, guías ES/EN y 4 MP3. Precio: 9 €." },
      en: { title: "Trap Ritual: dark trap prompts for Suno | SUBSUELO FS", description: "30 dark trap prompts for Suno, tested with real references. Includes 10 negative prompts, ES/EN guides and 4 MP3s. Price: €9." }
    },
    garage: {
      es: { title: "Garaje Oscuro: prompts de UK garage para Suno | SUBSUELO FS", description: "30 prompts de UK garage oscuro para Suno, probados con referencias reales. Incluye 10 negative prompts, guías ES/EN y 4 MP3. Precio: 9 €." },
      en: { title: "Garaje Oscuro: dark UK garage prompts for Suno | SUBSUELO FS", description: "30 dark UK garage prompts for Suno, tested with real references. Includes 10 negative prompts, ES/EN guides and 4 MP3s. Price: €9." }
    },
    jungle: {
      es: { title: "Fossil Jungle: prompts de jungle oscuro para Suno | SUBSUELO FS", description: "30 prompts de jungle oscuro para Suno, probados con referencias reales. Incluye 10 negative prompts, guías ES/EN y 4 MP3. Precio: 9 €." },
      en: { title: "Fossil Jungle: dark jungle prompts for Suno | SUBSUELO FS", description: "30 dark jungle prompts for Suno, tested with real references. Includes 10 negative prompts, ES/EN guides and 4 MP3s. Price: €9." }
    },
    low: {
      es: { title: "Low Pressure: prompts de hip-hop para Suno | SUBSUELO FS", description: "30 prompts de hip-hop abstracto para Suno, probados con referencias reales. Incluye 10 negative prompts, guías ES/EN y 4 MP3. Precio: 9 €." },
      en: { title: "Low Pressure: abstract hip-hop prompts for Suno | SUBSUELO FS", description: "30 abstract hip-hop prompts for Suno, tested with real references. Includes 10 negative prompts, ES/EN guides and 4 MP3s. Price: €9." }
    },
    abyss: {
      es: { title: "Abyss Dub: prompts de hip-hop dub para Suno | SUBSUELO FS", description: "30 prompts de hip-hop dub para Suno, probados con referencias reales. Incluye 10 negative prompts, guías ES/EN y 4 MP3. Precio: 9 €." },
      en: { title: "Abyss Dub: dark dub hip-hop prompts for Suno | SUBSUELO FS", description: "30 dark dub hip-hop prompts for Suno, tested with real references. Includes 10 negative prompts, ES/EN guides and 4 MP3s. Price: €9." }
    },
    noir: {
      es: { title: "Noir Tapes: prompts de hip-hop noir para Suno | SUBSUELO FS", description: "30 prompts de hip-hop noir para Suno, probados con referencias reales. Incluye 10 negative prompts, guías ES/EN y 4 MP3. Precio: 9 €." },
      en: { title: "Noir Tapes: noir hip-hop prompts for Suno | SUBSUELO FS", description: "30 noir hip-hop prompts for Suno, tested with real references. Includes 10 negative prompts, ES/EN guides and 4 MP3s. Price: €9." }
    },
    dust: {
      es: { title: "Prompts para Suno de country moderno y outlaw | SUBSUELO FS", description: "30 prompts para Suno de country moderno, outlaw, americana oscura y country rock, con 10 negative prompts, guías ES/EN y 4 MP3. Precio: 9 €." },
      en: { title: "Suno Country Music Prompts: Modern & Outlaw | SUBSUELO FS", description: "30 Suno country music prompts for modern country, outlaw, dark Americana and country rock, plus 10 negative prompts, ES/EN guides and 4 MP3s. €9." }
    },
    iron: {
      es: { title: "Prompts para Suno de metal sinfónico y doom | SUBSUELO FS", description: "30 prompts para Suno de metal sinfónico, doom y gótico, con 10 negative prompts, guías ES/EN y 4 MP3 reales. Precio: 9 €." },
      en: { title: "Suno Metal Prompts: Symphonic, Doom & Gothic | SUBSUELO FS", description: "30 Suno metal prompts for symphonic metal, doom and gothic metal, plus 10 negative prompts, ES/EN guides and 4 real MP3 references. €9." }
    }
  });
  ...
  let lastTrackPlacement = "unknown";
  ...
  const parseRoute = (path = currentPath(), fallbackLocale = null) => {
    ...
    if (parts.length === 1 && familyRouteIds.has(parts[0])) return routed({ type: "family", family: familyRouteIds.get(parts[0]) });
  ...
  const routePath = (route) => {
    let path = "/";
    if (route.type === "family") path = `/${familyById[route.family].slug}/`;
  ...
  const routeMetadata = (route) => {
    ...
    if (route.type === "bundle") return language === "es"
      ? { title: `180 prompts para Suno: pack completo | ${legalProfile.brand}`, description: `Las 6 colecciones probadas en Suno en un ZIP: 180 prompts, 60 negative prompts, guías ES/EN y 24 referencias MP3. Precio: ${price(archive.price)}.`, canonicalPath: localizedPath("/bundle/", route.locale), type: "product" }
      : { title: `180 Suno prompts: complete pack | ${legalProfile.brand}`, description: `All 6 Suno-tested collections in one ZIP: 180 prompts, 60 negative prompts, ES/EN guides and 24 MP3 references. Price: ${price(archive.price)}.`, canonicalPath: localizedPath("/bundle/", route.locale), type: "product" };
    if (route.type === "demos") return language === "es"
      ? { title: `Demos de prompts para Suno por género | ${legalProfile.brand}`, description: "Escucha ocho resultados probados en Suno: trap, UK garage, jungle, hip-hop, dub, noir, country y metal sinfónico.", canonicalPath: localizedPath("/demos/", route.locale), type: "website" }
      : { title: `Suno prompt demos: eight genres | ${legalProfile.brand}`, description: "Hear eight tested Suno prompt results: trap, UK garage, jungle, hip-hop, dub, noir, country and symphonic metal.", canonicalPath: localizedPath("/demos/", route.locale), type: "website" };
    if (route.type === "help") return language === "es"
      ? { title: `Cómo usar nuestros prompts en Suno | ${legalProfile.brand}`, description: "Qué contiene cada carpeta para Suno, qué va en Styles y Exclude, cómo funcionan los negative prompts y qué muestran las referencias probadas.", canonicalPath: localizedPath("/help/", route.locale), type: "website" }
      : { title: `How to use our Suno prompts | ${legalProfile.brand}`, description: "See what each Suno prompt folder contains, what goes in Styles and Exclude, how negative prompts work and what the tested references show.", canonicalPath: localizedPath("/help/", route.locale), type: "website" };
    if (route.type === "family") {
      const family = familyById[route.family];
      return { ...family.meta[language], canonicalPath: localizedPath(`/${family.slug}/`, route.locale), type: "website" };
    }
    ...
    return language === "es"
      ? { title: `Prompts para Suno de country, metal, trap y hip-hop | ${legalProfile.brand}`, description: "Ocho packs de prompts probados en Suno: country, metal sinfónico, trap, UK garage, jungle, hip-hop, dub y noir. Cada pack cuesta 9 €.", canonicalPath: localizedPath("/", route.locale), type: "website" }
      : { title: `Suno prompts for country, metal, trap and hip-hop | ${legalProfile.brand}`, description: "Eight tested Suno prompt packs: country, symphonic metal, trap, UK garage, jungle, hip-hop, dub and noir. €9 per pack.", canonicalPath: localizedPath("/", route.locale), type: "website" };
  };
  ...
  const parentPath = (route) => {
    ...
    if (route.type === "product" || route.type === "family" || route.type === "category" || route.type === "demos" || route.type === "help" || route.type === "legal" || route.type === "bundle") return "/";
    return null;
  };
  ...
  const breadcrumbData = (route) => {
    ...
    if (route.type === "family") {
      const family = familyById[route.family];
      items.push({ label: t(family.label), route: routePath(route) });
    }
  ...
  const renderBreadcrumbs = (route) => {
    ...
    $("[data-breadcrumb]").innerHTML = items.map((item, index) => {
      ...
      const crawlable = target.type === "home" || target.type === "family" || target.type === "demos" || target.type === "bundle" || target.type === "help" || target.type === "legal" || (target.type === "product" && !target.section);
      return crawlable
  ...
  const sidebarFamilyMarkup = (family, route) => {
    const activeCategory = route.type === "category"
      ...
      : route.type === "product"
        ...
        : null;
    const isActiveFamily = route.type === "family" ? route.family === family.id : family.categories.includes(activeCategory);
    const open = isActiveFamily && !window.matchMedia("(max-width: 900px)").matches;
    const familyRoute = `/${family.slug}/`;
    const overview = treeItem({
      route: familyRoute,
      label: t("sidebar.familyOverview"),
      icon: "folder",
      count: family.products.length,
      current: route.type === "family" && route.family === family.id,
      crawlable: true
    });
    ...
    return `<details class="tree-family"${open ? " open" : ""} data-sidebar-family="${family.id}"><summary><span class="tree-family__marker" aria-hidden="true"></span><span>${t(family.label)}</span><small>${count}</small></summary><nav>${overview}${items}</nav></details>`;
  };
  ...
  const renderSidebar = (route) => {
    ...
    $("[data-sidebar-categories]").innerHTML = familyDefinitions.map((family) => sidebarFamilyMarkup(family, route)).join("");
  ...
  const folderMarkup = (product) => {
    ...
    const promise = product.bundle ? product.description[language] : productPitches[product.id][language];
    const label = `${name}. ${detail}. ${promise} ${price(product.price)}`;
    const href = routeHref(product.bundle ? "/bundle/" : `/product/${product.id}/`);
    const priceMarkup = `<b>${price(product.price)}</b>`;
    return `<a class="folder-item ${selectedProductId === product.id ? "is-selected" : ""}" href="${href}" data-product-id="${product.id}" aria-label="${escapeHtml(label)}"><span class="folder-icon ${product.bundle ? "folder-icon--bundle" : ""}" style="--tone:${product.tone}"></span><strong>${escapeHtml(name)}</strong><small>${escapeHtml(detail)}</small><span class="folder-item__promise">${escapeHtml(promise)}</span><span class="folder-list-price">${priceMarkup}</span></a>`;
  };
  ...
  const homeView = (route) => {
    ...
    const folders = matches.length ? `<div class="folder-grid ${viewMode === "list" ? "is-list" : ""}" id="packs-en-oferta" data-folder-grid>${matches.map(folderMarkup).join("")}</div>` : `<div class="empty-state" id="packs-en-oferta"><div class="empty-folder"></div><h2>${t("home.empty")}</h2><p>${t("home.emptyHint")}</p><button class="help-action" type="button" data-clear-search>${t("home.clear")}</button></div>`;
    ...
    const labHref = localizedPath("/lab/", language);
    ...
    return `<header class="view-heading"><div class="view-heading__copy"><p>${t("home.kicker")}</p><h1>${escapeHtml(title)}</h1><p>${escapeHtml(lead)}</p></div><p class="view-heading__hint">${hint}</p></header>${folders}${offer}<section class="system-files"><h2>${t("home.docs")}</h2><div class="system-file-row"><a class="system-file" href="${helpHref}" data-route="${helpHref}"><span class="file-icon file-icon--text">TXT</span><strong>${t("home.helpFile")}</strong></a><a class="system-file" href="${demosHref}" data-route="${demosHref}"><span class="file-icon file-icon--audio">AUDIO</span><strong>${t("home.demoFile")}</strong></a><a class="system-file" href="${guidesHref}" data-editorial-path="/guides/"><span class="row-folder-icon"></span><strong>${t("home.guidesFile")}</strong></a><a class="system-file" href="${labHref}" data-editorial-path="/lab/"><span class="row-folder-icon"></span><strong>${t("home.labFile")}</strong></a><a class="system-file" href="${bundleHref}" data-route="${bundleHref}"><span class="row-folder-icon"></span><strong>${t("home.bundleFile")}</strong></a><a class="system-file" href="${legalHref}" data-route="${legalHref}"><span class="row-folder-icon"></span><strong>${t("home.legalFile")}</strong></a></div></section>`;
  };

  const familyView = (family) => {
    const familyProducts = family.products.map((id) => products[id]);
    const comparisonRows = familyProducts.map((product) => {
      const href = routeHref(`/product/${product.id}/`);
      const editorial = productEditorial[product.id];
      return `<article class="family-pack" style="--tone:${product.tone}" data-track="${product.id}"><header><span class="folder-icon" style="--tone:${product.tone}" aria-hidden="true"></span><div><p>${escapeHtml(categoryName(product.tags[0]))}</p><h3><a href="${href}" data-route="${href}">${escapeHtml(productName(product))}</a></h3></div><strong>${price(product.price)}</strong></header><p class="family-pack__promise">${escapeHtml(productPitches[product.id][language])}</p><dl><div><dt>${language === "en" ? "Core sound" : "Sonido central"}</dt><dd>${escapeHtml(editorial.core[language])}</dd></div><div><dt>${language === "en" ? "Choose it if" : "Elígelo si buscas"}</dt><dd>${escapeHtml(editorial.fit[language])}</dd></div></dl><div class="family-pack__demo"><span><b>${escapeHtml(product.demo.title)}</b><small>${escapeHtml(editorial.demo[language])}</small></span><button type="button" data-play="${product.id}" data-play-placement="family_${family.id}">${language === "en" ? "Hear 30 sec" : "Escuchar 30 s"}</button><button class="primary-action" type="button" data-buy="${product.id}" data-buy-placement="family_${family.id}">${language === "en" ? `Buy · ${price(product.price)}` : `Comprar · ${price(product.price)}`}</button></div></article>`;
    }).join("");
    const guides = family.guides.map((slug) => {
      const href = localizedPath(`/guides/${slug}/`, language);
      return `<a href="${href}"><span class="file-icon file-icon--text">TXT</span><span><strong>${escapeHtml(guideLabels[slug][language])}</strong><small>${language === "en" ? "Practical production guide" : "Guía práctica de producción"}</small></span></a>`;
    }).join("");
    const compareHref = localizedPath("/compare/", language);
    const demosHref = routeHref("/demos/");
    return `<header class="family-hero" style="--family-count:${familyProducts.length}"><div><p>${language === "en" ? "SOUND FAMILY" : "FAMILIA SONORA"} / ${escapeHtml(t(family.label))}</p><h1>${escapeHtml(family.title[language])}</h1><p>${escapeHtml(family.lead[language])}</p></div><aside><strong>${familyProducts.length}</strong><span>${language === "en" ? "packs to compare" : "packs para comparar"}</span><small>30 prompts + 10 negative prompts + 4 MP3 / pack</small></aside></header><section class="family-choice" aria-labelledby="family-choice-title"><header><p>${language === "en" ? "CHOOSE BY RESULT" : "ELIGE POR RESULTADO"}</p><h2 id="family-choice-title">${language === "en" ? "Each folder solves a different production brief." : "Cada carpeta resuelve una dirección de producción distinta."}</h2></header><div class="folder-grid family-folder-grid" style="--family-count:${familyProducts.length}" data-folder-grid>${familyProducts.map(folderMarkup).join("")}</div></section><section class="family-comparison" aria-labelledby="family-comparison-title"><header><p>${language === "en" ? "LISTEN / COMPARE / BUY" : "ESCUCHA / COMPARA / COMPRA"}</p><h2 id="family-comparison-title">${language === "en" ? "Hear the difference before choosing." : "Escucha la diferencia antes de elegir."}</h2><span>${language === "en" ? "Every preview comes from prompt 001 in its folder." : "Cada muestra procede del prompt 001 de su carpeta."}</span></header><div>${comparisonRows}</div></section><section class="family-guides"><header><p>${language === "en" ? "KEEP EXPLORING" : "SIGUE EXPLORANDO"}</p><h2>${language === "en" ? "Guides for this sound family" : "Guías para esta familia sonora"}</h2></header><div>${guides}</div><nav><a href="${compareHref}">${language === "en" ? "Compare all eight packs" : "Comparar los ocho packs"}</a><a href="${demosHref}" data-route="${demosHref}">${language === "en" ? "Hear every demo" : "Escuchar todas las demos"}</a><a href="${freeSampler.url}" target="_blank" rel="noopener noreferrer" data-sampler-download="family_${family.id}">${language === "en" ? "Try the free sampler · €0" : "Probar muestra gratis · 0 €"} ↗</a></nav></section>`;
  };
  ...
  const emptyInspector = () => `<div class="inspector-empty"><span class="folder-icon"></span><h2>${t("inspector.select")}</h2><p>${t("inspector.selectHint")}</p></div><aside class="inspector-sampler"><p>${t("inspector.samplerKicker")}</p><h3>${t("inspector.samplerTitle")}</h3><span class="file-icon file-icon--zip" aria-hidden="true">ZIP</span><p>${t("inspector.samplerText")}</p><a class="primary-action" href="${freeSampler.url}" target="_blank" rel="noopener noreferrer" data-sampler-download="inspector">${t("inspector.samplerAction")} ↗</a><small>${t("inspector.samplerHint")}</small></aside>`;
  ...
  const productBanner = (product) => `<section class="product-banner" style="--tone:${product.tone}"><div class="product-banner__art"></div><div><p class="kicker">${t("product.edition")} / ${escapeHtml(categoryName(product.tags[0]))}</p><h1>${escapeHtml(productName(product))}</h1><p>${escapeHtml(product.description[language])}</p>${product.bundle ? "" : `<p class="product-banner__compatibility">${t("product.compatibility")}</p>`}</div><div class="product-banner__buy"><div class="product-banner__price"><strong>${price(product.price)}</strong>${product.bundle ? "" : `<span class="price-per-prompt">${t("product.perPrompt")}</span>`}</div><div class="product-banner__actions"><button type="button" data-play="${product.id}" data-play-placement="product_banner">${t("product.play")}</button><button class="primary-action" type="button" data-buy="${product.id}" data-buy-placement="product_banner">${t("product.buy")} · ${price(product.price)}</button></div><a class="product-banner__sampler" href="${freeSampler.url}" target="_blank" rel="noopener noreferrer" data-sampler-download="product">${t("product.sampler")} ↗</a></div></section>`;
  ...
  const purchaseStrip = (product) => {
    ...
    return `<div class="purchase-strip"><div><strong>${escapeHtml(productName(product))} · ${productPrice}</strong><span>${escapeHtml(productDetail)}</span></div><div class="purchase-strip__actions">${product.demo ? `<button type="button" data-play="${product.id}" data-play-placement="purchase_strip">${t("product.play")}</button>` : ""}<button class="primary-action" type="button" data-buy="${product.id}" data-buy-placement="purchase_strip">${t("product.buy")} · ${price(product.price)}</button></div></div>`;
  };
  ...
  const productRootView = (product) => {
    ...
    const upsell = product.bundle || !archive.members.includes(product.id) ? "" : `<aside class="bundle-upsell"><div><strong>${t("product.upsellTitle")}</strong><span>${t("product.upsellText")}</span></div><a class="bundle-upsell__action" href="${routeHref("/bundle/")}" data-route="${routeHref("/bundle/")}">${t("product.upsellAction")}</a></aside>`;
    return `${productBanner(product)}${promptProofView(product)}<header class="subfolder-heading"><span class="folder-icon" style="--tone:${product.tone}"></span><div><h2>${t("product.contents")}</h2><p>${t("product.files", { count: rows.length })}</p></div></header>${fileList(rows)}${profile}${upsell}${purchaseStrip(product)}`;
  };
  ...
  const demosView = () => {
    const rows = catalog.map((product) => { const href = routeHref(`/product/${product.id}/`); return `<div class="file-row" data-track="${product.id}"><span class="file-row__name">${rowIcon("audio")}<span><strong>${escapeHtml(product.demo.title)}</strong><small class="demo-profile">${escapeHtml(productEditorial[product.id].demo[language])}</small></span></span><span><a href="${href}" data-route="${href}">${escapeHtml(productName(product))}</a></span><span>${product.demo.durationLabel}</span><span class="demo-row-actions"><button class="file-row__action" type="button" data-play="${product.id}" data-play-placement="demos">${t("product.listen")}</button><button class="file-row__action file-row__action--primary" type="button" data-add="${product.id}" data-add-placement="demos">${t("inspector.add")} · ${price(product.price)}</button></span></div>`; });
    return `<header class="view-heading"><div class="view-heading__copy"><p>${t("demos.kicker")}</p><h1>${t("demos.title")}</h1><p>${t("demos.lead")}</p></div></header><div class="file-list demo-list"><div class="file-list__header"><span>${t("demos.track")}</span><span>${t("demos.edition")}</span><span>${t("demos.length")}</span><span>${t("demos.action")}</span></div>${rows.join("")}</div><aside class="demos-sampler"><div><strong>${t("demos.samplerTitle")}</strong><span>${t("demos.samplerText")}</span></div><a class="demos-sampler__action" href="${freeSampler.url}" target="_blank" rel="noopener noreferrer" data-sampler-download="demos">${t("demos.samplerAction")} ↗</a></aside>`;
  };
  ...
  const renderStatus = (route) => {
    ...
    else if (route.type === "family") count = familyById[route.family].products.length;
  ...
  const renderRoute = () => {
    ...
    if (route.type === "family") html = familyView(familyById[route.family]);
    ...
    if (routeChanged) {
      if (lastRenderedRoute !== null) window.SUBSUELO_PAGEVIEW?.();
      if (route.type === "family") trackEvent("family_view", { family: route.family, locale: language });
      if (route.type === "product") trackEvent("product_view", { pack: route.id, locale: language });
  ...
  const addToCart = (id, placement = "unknown") => {
    ...
    if (product.bundle) {
      ...
      if (!alreadyPresent || replaced) trackEvent("cart_add", { pack: id, placement, cart_size: cart.length });
      return !alreadyPresent || replaced;
    }
    const containingBundle = cart.map((item) => products[item]).find((item) => item?.bundle && item.members.includes(id));
    if (containingBundle) {
      showToast(t("messages.bundleContains"));
      return false;
    }
    if (cart.includes(id)) {
      showToast(t("messages.duplicate"));
      return false;
    }
    cart.push(id);
    renderCart();
    showToast(t("messages.added", { name: productName(product) }));
    trackEvent("cart_add", { pack: id, placement, cart_size: cart.length });
    return true;
  };
  ...
  const sidebarFilePane = $(".file-pane");
  ...
  const syncSidebarA11y = () => {
    ...
    sidebarFilePane.inert = mobileOpen;
  ...
  document.addEventListener("click", (event) => {
    if (event.target.closest("[data-demo-offer-close]")) {
      if (demoOfferDialog.open) demoOfferDialog.close("dismiss");
      return;
    }
    ...
    if (samplerDownload) {
      ...
      if (demoOfferDialog.open) demoOfferDialog.close("sampler");
      return;
    }
    ...
    if (routeButton) {
      ...
      if (demoOfferDialog.open) demoOfferDialog.close("open_product");
    ...
    if (play) { startTrack(play.dataset.play, play.dataset.playPlacement || "unknown"); return; }
    ...
    if (buy) {
      event.preventDefault();
      const placement = buy.dataset.buyPlacement || "unknown";
      trackEvent("purchase_intent", { pack: buy.dataset.buy, placement });
      if (demoOfferDialog.open) demoOfferDialog.close("buy");
      addToCart(buy.dataset.buy, placement);
      if (cart.length) openCheckoutReview();
      return;
    }
    const add = event.target.closest("[data-add]");
    if (add) { addToCart(add.dataset.add, add.dataset.addPlacement || "unknown"); return; }
  ...
  const payhipCheckoutUrl = () => {
    ...
    params.set("metadata[source_site]", "subsuelofs");
    params.set("metadata[cart_type]", cartType);
    params.set("metadata[entry_route]", attributionValue(location.pathname) || "home");
  ...
  checkoutForm.addEventListener("submit", (event) => {
    ...
    trackEvent("checkout_submit", { cart_type: cart.length === 1 ? cart[0] : "multi" });
  ...
  const demoOfferDialog = $("[data-demo-offer]");
  let demoOfferProductId = null;
  const showDemoOffer = (id) => {
    const product = products[id];
    if (!product || demoOfferDialog.open || checkoutDialog.open) return;
    demoOfferProductId = id;
    $("[data-demo-offer-icon]").style.setProperty("--tone", product.tone);
    $("[data-demo-offer-product]").textContent = `${productName(product)} · ${product.demo.title}`;
    $("[data-demo-offer-promise]").textContent = productPitches[id][language];
    $("[data-demo-offer-price]").textContent = price(product.price);
    $("[data-demo-offer-button-price]").textContent = price(product.price);
    const buyButton = $("[data-demo-offer-buy]");
    buyButton.dataset.buy = id;
    const productHref = routeHref(`/product/${id}/`);
    const productLink = $("[data-demo-offer-open]");
    productLink.href = productHref;
    productLink.dataset.route = productHref;
    demoOfferDialog.showModal();
    trackEvent("demo_offer_view", { pack: id, route: parseRoute().type });
    buyButton.focus();
  };
  demoOfferDialog.addEventListener("click", (event) => {
    if (event.target === demoOfferDialog) demoOfferDialog.close("backdrop");
  });
  demoOfferDialog.addEventListener("close", () => {
    if (demoOfferProductId && !["buy", "open_product", "sampler"].includes(demoOfferDialog.returnValue)) {
      trackEvent("demo_offer_close", { pack: demoOfferProductId, reason: demoOfferDialog.returnValue || "escape" });
    }
    demoOfferProductId = null;
  });
  ...
  function startTrack(id, placement = "unknown") {
    const product = products[id];
    if (!product?.demo) return;
    ...
    stopTrack();
    lastTrackId = id;
    lastTrackPlacement = placement;
    const audio = new Audio(product.demo.src);
    audio.preload = "metadata";
    activeTrack = { id, audio, placement };
    ...
    audio.addEventListener("play", () => {
      if (!trackedDemoIds.has(id)) {
        ...
        trackEvent("demo_start", { pack: id, placement });
      }
      updateAudioUi();
    });
    ...
    audio.addEventListener("ended", () => {
      ...
      if (!completedDemoIds.has(id)) {
        ...
        trackEvent("demo_complete", { pack: id, placement });
      }
      stopTrack();
      showDemoOffer(id);
    });
  ...
  $("[data-dock-toggle]").addEventListener("click", () => activeTrack ? startTrack(activeTrack.id, activeTrack.placement) : lastTrackId && startTrack(lastTrackId, lastTrackPlacement));
