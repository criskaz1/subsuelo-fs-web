(() => {
  ...
  const copy = {
    es: {
      meta: { title: "Prompts para Suno de trap y hip-hop | SUBSUELO FS", description: "Seis packs de prompts probados en Suno: trap, UK garage, jungle, hip-hop abstracto, dub y noir. 9 € cada uno o 49 € completos." },
      ...
      home: {
        ...
        offerAria: "Packs individuales", offerKicker: "CATÁLOGO / 6 PACKS INDIVIDUALES", offerTitle: "Elige cualquier pack por 9 €.", offerText: "Cada pack incluye 30 prompts para Suno, 10 negative prompts, guías ES/EN y 4 referencias MP3 probadas.", offerCompatibility: "Elige Trap, Garage, Jungle, Hip-Hop abstracto, Dub o Noir. Precio único por pack: 9 €.", offerPrice: "9 €", offerOpening: "PRECIO ACTUAL POR PACK", offerAction: "ELEGIR PACK · 9 €", offerSecondary: "ESCUCHAR LAS 6 DEMOS",
    ...
    product: { edition: "CARPETA DE PROMPTS", compatibility: "Compatible con Suno · referencia generada y comprobada el 15/07/2026", demoFolderName: "AUDIO_EXAMPLES", add: "Añadir al carrito", buy: "Comprar ahora", play: "Escuchar 30 s", sampler: "Probar muestra gratis · 0 €", contents: "Contenido de la descarga", name: "Nombre", type: "Tipo", folder: "Carpeta", description: "Qué contiene", availability: "Acceso", purchase: "Descarga disponible después del pago", files: "{count} elementos", included: "Incluido en la descarga", available: "Disponible después de la compra", public: "Información pública", details: "Ver información", open: "Abrir", listen: "Escuchar", readme: "Resumen de la descarga, organización de los archivos y primeros pasos.", promptsFolder: "PDF con todos los prompts en inglés, numerados y listos para copiar.", negativesFolder: "PDF separado con todos los negative prompts en inglés, numerados y listos para copiar.", guideFile: "Explica dónde pegar cada texto, cómo crear con o sin voz y qué cambia al mover los controles.", demosFolder: "Carpeta con 4 MP3 incluidos para escucha y referencia. El reproductor público ofrece una muestra.", audioIncluded: "MP3 completo incluido para escucha y referencia después del pago.", previewDescription: "Extracto público de 30 segundos de uno de los audios incluidos.", demosIncluded: "4 MP3 incluidos + muestra pública", licenseFile: "Condiciones de uso de los prompts, negative prompts y audios de ejemplo.", esFolder: "Documentos en español; los textos que se copian permanecen en inglés.", enFolder: "Documentos en inglés; los prompts preparados para copiar también están en inglés.", format: "Formato", language: "Idioma", content: "Contenido", english: "Inglés", spanishDocs: "Español · prompts en inglés", englishDocs: "Inglés · prompts en inglés", afterPurchase: "Se entrega dentro de la descarga después del pago.", review: "Puedes comprobar qué contiene y en qué idioma está antes de comprar.", mainPrompt: "Prompt completo en inglés, listo para copiar.", negativePrompt: "Lista en inglés para pegar en Exclude.", audioPreview: "Muestra pública", previewOnly: "Solo escucha", notInZip: "La escucha pública es una muestra; la compra incluye 4 MP3 para referencia.", perPrompt: "0,30 € por prompt", upsellTitle: "¿Te interesan varios géneros?", upsellText: "Pack completo: las 6 carpetas por 49 € · ahorras 5 €", upsellAction: "Ver pack completo · 49 €" },
      ...
      demos: { kicker: "AUDIO / MUESTRAS", title: "Escucha seis resultados de prompts para Suno.", lead: "Cada muestra se generó con un prompt de su carpeta correspondiente. Cada pack incluye además 4 MP3 completos que muestran el sonido probado.", track: "Pista", edition: "Carpeta", length: "Duración", action: "Acción", open: "Abrir carpeta", samplerTitle: "¿Te gusta lo que oyes?", samplerText: "La muestra gratuita incluye 6 prompts, 7 negative prompts y estas seis demos.", samplerAction: "Probar muestra gratis · 0 €" },
    ...
    en: {
      meta: { title: "Suno prompts for dark trap and hip-hop | SUBSUELO FS", description: "Six tested Suno prompt packs for dark instrumentals: trap, UK garage, jungle, abstract hip-hop, dub and noir. €9 each or €49 complete." },
      ...
      home: {
        ...
        offerAria: "Individual packs", offerKicker: "CATALOGUE / 6 INDIVIDUAL PACKS", offerTitle: "Choose any pack for €9.", offerText: "Every pack includes 30 Suno prompts, 10 negative prompts, ES/EN guides and 4 tested MP3 references.", offerCompatibility: "Choose Trap, Garage, Jungle, Abstract Hip-Hop, Dub or Noir. One-off price per pack: €9.", offerPrice: "€9", offerOpening: "CURRENT PRICE PER PACK", offerAction: "CHOOSE A PACK · €9", offerSecondary: "HEAR THE 6 DEMOS",
      ...
      demos: { kicker: "AUDIO / PREVIEWS", title: "Hear six Suno prompt results before you choose.", lead: "Each preview was generated from a prompt in its corresponding folder. Every pack also includes four full MP3 references that show the tested sound.", track: "Track", edition: "Folder", length: "Length", action: "Action", open: "Open folder", samplerTitle: "Like what you hear?", samplerText: "The free sampler includes 6 prompts, 7 negative prompts and these six demos.", samplerAction: "Try free sampler · €0" },
  ...
  const routeMetadata = (route) => {
    ...
    if (route.type === "demos") return language === "es"
      ? { title: `Demos de prompts para Suno por género | ${legalProfile.brand}`, description: "Escucha seis resultados de prompts probados en Suno: trap ritual, UK garage oscuro, jungle degradado, hip-hop abstracto, dub y noir.", canonicalPath: localizedPath("/demos/", route.locale), type: "website" }
      : { title: `Suno prompt demos: six dark genres | ${legalProfile.brand}`, description: "Hear six tested Suno prompt results: ritual trap, dark UK garage, degraded jungle, abstract hip-hop, dub and noir.", canonicalPath: localizedPath("/demos/", route.locale), type: "website" };
    ...
    return language === "es"
      ? { title: `Prompts para Suno de trap y hip-hop | ${legalProfile.brand}`, description: "Seis packs de prompts probados en Suno: trap, UK garage, jungle, hip-hop abstracto, dub y noir. 9 € cada uno o 49 € completos.", canonicalPath: localizedPath("/", route.locale), type: "website" }
      : { title: `Suno prompts for dark trap and hip-hop | ${legalProfile.brand}`, description: "Six tested Suno prompt packs for dark instrumentals: trap, UK garage, jungle, abstract hip-hop, dub and noir. €9 each or €49 complete.", canonicalPath: localizedPath("/", route.locale), type: "website" };
  };
  ...
  const productRootView = (product) => {
    ...
    const upsell = product.bundle ? "" : `<aside class="bundle-upsell"><div><strong>${t("product.upsellTitle")}</strong><span>${t("product.upsellText")}</span></div><a class="bundle-upsell__action" href="${routeHref("/bundle/")}" data-route="${routeHref("/bundle/")}">${t("product.upsellAction")}</a></aside>`;
