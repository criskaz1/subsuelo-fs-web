(() => {
  ...
  const copy = {
    es: {
      ...
      demos: { kicker: "AUDIO / MUESTRAS", title: "Muestras de audio", lead: "Escucha una muestra pública de cada carpeta. Cada compra incluye además 4 MP3 completos para referencia sonora.", track: "Pista", edition: "Carpeta", length: "Duración", action: "Acción", open: "Abrir carpeta", samplerTitle: "¿Te gusta lo que oyes?", samplerText: "La muestra gratuita incluye 6 prompts, 7 negative prompts y estas seis demos.", samplerAction: "Probar muestra gratis · 0 €" },
      bundle: { kicker: "PACK COMPLETO", title: "Todas las carpetas", lead: "Incluye en un solo ZIP todas las carpetas enumeradas debajo. La compra cubre únicamente esas carpetas; las publicaciones futuras se venden por separado.", members: "Carpetas incluidas", add: "Añadir pack completo", item: "Incluida en el pack", folderCount: "{count} carpetas", saving: "Precio actual de los seis por separado: {separate} · Ahorras {saving} · 0,27 € por prompt" },
    ...
    en: {
      ...
      home: {
        kicker: "SUBSUELO / CATALOGUE", title: "One genre. 30 ways in.", lead: "Pick the sound you want to make. Each folder gives you 30 prompts that change the drums, bass, lead source and space while staying inside one coherent genre.", hint: "Click a folder to open it", mobileHint: "Tap a folder to open it", docs: "MORE INFORMATION", helpFile: "WHAT_EACH_FOLDER_INCLUDES.txt", demoFile: "HEAR_THE_EXAMPLES.audio", guidesFile: "PRODUCTION_GUIDES.folder", bundleFile: "COMPLETE_PACK.folder", legalFile: "LEGAL_AND_PRIVACY.folder", labFile: "PROMPT_LAB.folder", empty: "No results for this search.", emptyHint: "Try another name or clear the search.", clear: "Clear search",
