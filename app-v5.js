(() => {
  ...
  const copy = {
    ...
    en: {
      ...
      home: { kicker: "SUBSUELO / CATALOGUE", title: "One genre. 30 ways in.", lead: "Pick the sound you want to make. Each folder gives you 30 prompts that change the drums, bass, lead source and space while staying inside one coherent genre.", hint: "Click a folder to open it", mobileHint: "Tap a folder to open it", docs: "MORE INFORMATION", helpFile: "WHAT_EACH_FOLDER_INCLUDES.txt", demoFile: "HEAR_THE_EXAMPLES.audio", guidesFile: "PRODUCTION_GUIDES.folder", bundleFile: "COMPLETE_PACK.folder", legalFile: "LEGAL_AND_PRIVACY.folder", empty: "No results for this search.", emptyHint: "Try another name or clear the search.", clear: "Clear search", samplerKicker: "FREE SAMPLER / ZIP", samplerTitle: "Try the format before choosing.", samplerText: "Get 6 prompts, 7 negative prompts, separate Spanish and English guides, and six 30-second demos: one entry from every folder.", samplerDelivery: "Instant delivery by email · No account required", samplerAction: "GET THE SAMPLER · 0 €", samplerAria: "Get the free sampler (opens in a new tab)" },
